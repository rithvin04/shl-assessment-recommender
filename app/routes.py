...
async def chat(
    ...
    try:
        ...
        if analysis["intent"] == "compare":
            comparison = retriever.compare(analysis["comparison"])
            ...
            if len(found) != 2:
                ...
                reply += "I can only compare assessments that exist in the SHL catalog."
            ...
            first = found[0]
            second = found[1]
            reply = generate_comparison(first, second)
